...
class FloorPlanner:
    ...
    def matplotlib_draw(self):
        ...
        for block in self.blocks.values():
            ...
            #print(f"Block: {block_name} -> aspect ratio: {width/length}")
        # Set the x and y limits
        plt.xlim(0, self.total_width*1.25)
        plt.ylim(0, self.total_length*1.25)
        plt.title("Floor-planning")
        plt.savefig(
            f"Floorplan_Area_{self.total_width*self.total_length}.png")
    ...
    def simulated_annealing(self):
        ...
        temperature_initial = (-delta_cost_mean)/log(0.99)

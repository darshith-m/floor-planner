        ...
        for _ in range(num_moves):
            ...
            if valid:
                ...
                if accept_flag:
                    ...
                    reject += 1
        #print(f"Thread {threading.current_thread().name} - Accept: {accept}, Reject: {reject}")
    ...
    def simulated_annealing(self):
        ...
        while temperature > temperature_freeze and current_cost > self.ideal_cost:
            ...
            for _ in range(num_threads):
                thread = threading.Thread(target=self.pertubation_worker, args=(polish_expression.copy(), num_moves_per_thread, temperature, current_cost, result_list))
